...
fun
array_list_free(al: array_list1):<!wrt> void = "mac#%"

(* ****** ****** *)

fun
array_list_length (al: !array_list1):<> intGte(0) = "mac#%"
...
//
fun
array_list_get_idx(al: !array_list1, i: intGte(0)):<> Ptr0 = "mac#%"
//
(* ****** ****** *)
//
fun
