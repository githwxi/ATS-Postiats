...
val (pfM, pfMgc | pM) = matrix_ptr_tabulate<T> (i2sz(M), i2sz(M))
...
val () = blas_gemm_row_nt (gint(1), !pM, !pM, gint(0), !pM2, M, M, M, M, M, M)
//
...
val () = fprint_matrix_sep (out, !pM, i2sz(M), i2sz(M), "; ", "\n")
