...
overload ptrcast with xmlElementPtr2ptr
...
fun
xmlAttr_get_name
  {l1:agz} (node: !xmlAttrPtr(l1)): xmlString = "mac#%"
fun
xmlAttr_get_type
  {l1:agz} (node: !xmlAttrPtr(l1)): xmlElementType = "mac#%"
...
overload __name with xmlAttr_get_name
...
overload __name with xmlNode_get_name
overload __type with xmlNode_get_type
overload __next with xmlNode_get_next
overload __prev with xmlNode_get_prev
overload __parent with xmlNode_get_parent
overload __children with xmlNode_get_children
overload __last with xmlNode_get_last
overload __content with xmlNode_get_content
overload __properties with xmlNode_get_properties
