...
//
val () =
  atscc2erl_main0(argc, addr@argv)
//
in true end with exn => auxexn(exn)
//
end (* end of [atscc2erl_main0_opt] *)
...
//
val
prfx = "libatscc2erl_string2file_"
//
val
...
val () = $UN.ptr0_set<string>(p0, "atscc2erl")
//
val
[n:int]
argc =
...
//
val
ans = atscc2erl_main0_opt(argc+1, !argv)
//
...
end // end of [atscc2erl_main0_arglst]
//
(* ****** ****** *)

(* end of [libatscc2erl_ext.dats] *)
