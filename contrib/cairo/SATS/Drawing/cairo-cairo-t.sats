...
*/
fun cairo_create
  (target: !xrsf1) : xr1 = "mac#atscntrb_cairo_create"
// end of [cairo_create]
...
*/
fun cairo_reference
  {l:agz} (x: !xr l): xr (l) = "mac#atscntrb_cairo_reference"
// end of [cairo_reference]

/*
void                cairo_destroy                       (cairo_t *cr);
*/
fun cairo_destroy (x: xr1): void = "mac#atscntrb_cairo_destroy"
...
*/
fun cairo_status
  (ctx: !xr1) : cairo_status_t = "mac#atscntrb_cairo_status"
// end of [cairo_status]
...
fun cairo_save
  ...
  cairo_save_v l | void
) = "mac#atscntrb_cairo_save" // a macro
...
) : void = "mac#atscntrb_cairo_restore" // a macro
...
fun cairo_get0_target
  {l1:agz} (
  ctx: !xr l1
) : [l2:agz] vtget0 (xr l1, xrsf l2) = "mac#atscntrb_cairo_get0_target"
...
fun cairo_push_group_with_content
  ...
  cairo_push_group_v l | void
) = "mac#atscntrb_cairo_push_group_with_content"
...
) : void = "mac#atscntrb_cairo_pop_group"
...
fun cairo_pop_group_to_source
  {l:agz} (
  pf: cairo_push_group_v l | ctx: !xr l
) : void = "mac#atscntrb_cairo_pop_group_to_source"
...
fun cairo_get0_group_target
  {l1:agz} (
  ctx: !xr l1
) : [l2:agz] vtget0 (xr l1, xrsf l2) = "mac#atscntrb_cairo_get0_group_target"
...
) : void = "mac#atscntrb_cairo_set_source_rgb" // end of [cairo_set_source_rgb]
...
) : void = "mac#atscntrb_cairo_set_source_rgba" // end of [cairo_set_source_rgba]
...
fun cairo_set_source
  (ctx: !xr1, src: !xrpat1): void = "mac#atscntrb_cairo_set_source"
...
) : void = "mac#atscntrb_cairo_set_source_surface" // end of [fun]
...
fun cairo_get0_source
  {l1:agz} (
  ctx: !xr l1
) : [l2:agz] vtget0 (xr l1, xrpat l2) = "mac#atscntrb_cairo_get0_source"
...
fun cairo_set_antialias
  (ctx: !xr1, aa: cairo_antialias_t): void = "mac#atscntrb_cairo_set_antialias"
...
fun cairo_get_antialias
  (ctx: !xr1): double = "mac#atscntrb_cairo_get_antialias"
...
) : void = "mac#atscntrb_cairo_set_dash"
...
fun cairo_get_dash_count
  (ctx: !xr1): int = "mac#atscntrb_cairo_get_dash_count"
...
fun cairo_set_fill_rule
  (ctx: !xr1, fr: cairo_fill_rule_t): void = "mac#atscntrb_cairo_set_fill_rule"
...
fun cairo_get_fill_rule
  (ctx: !xr1): cairo_fill_rule_t = "mac#atscntrb_cairo_get_fill_rule"
...
fun cairo_set_line_cap
  (ctx: !xr1, lc: cairo_line_cap_t): void = "mac#atscntrb_cairo_set_line_cap"
...
fun cairo_get_line_cap
  (ctx: !xr1): cairo_line_cap_t = "mac#atscntrb_cairo_get_line_cap"
...
fun cairo_set_line_join
  (ctx: !xr1, lj: cairo_line_join_t): void = "mac#atscntrb_cairo_set_line_join"
...
fun cairo_get_line_join
  (ctx: !xr1): cairo_line_join_t = "mac#atscntrb_cairo_get_line_join"
...
fun cairo_set_line_width
  (ctx: !xr1, width: double): void = "mac#atscntrb_cairo_set_line_width"
...
fun cairo_get_line_width
  (ctx: !xr1): double = "mac#atscntrb_cairo_get_line_width"
...
fun cairo_set_miter_limit
  (ctx: !xr1, limit: double): void = "mac#atscntrb_cairo_set_miter_limit"
...
fun cairo_get_miter_limit
  (ctx: !xr1): double = "mac#atscntrb_cairo_get_miter_limit"
...
fun cairo_set_operator
  (ctx: !xr1, opr: cairo_operator_t): void = "mac#atscntrb_cairo_set_operator"
...
fun cairo_get_operator
  (ctx: !xr1): cairo_operator_t = "mac#atscntrb_cairo_get_operator"
...
fun cairo_set_tolerance
  (ctx: !xr1, tolerance: double): void = "mac#atscntrb_cairo_set_tolerance"
...
fun cairo_get_tolerance
  (ctx: !xr1): double = "mac#atscntrb_cairo_get_tolerance"
...
*/
fun cairo_clip (ctx: !xr1): void = "mac#atscntrb_cairo_clip"

/*
void                cairo_clip_preserve                 (cairo_t *cr);
*/
fun cairo_clip_preserve (ctx: !xr1): void = "mac#atscntrb_cairo_clip_preserve"
...
, x2: &double? >> double
, y2: &double? >> double
) : void = "mac#atscntrb_cairo_clip_extents"
...
cairo_bool_t        cairo_in_clip                       (cairo_t *cr,
                                                         ...
                                                         double y);
*/
fun cairo_in_clip (ctx: !xr1): bool = "mac#atscntrb_cairo_in_clip"

/*
void                cairo_reset_clip                    (cairo_t *cr);
*/
fun cairo_reset_clip (ctx: !xr1): void = "mac#atscntrb_cairo_reset_clip"
...
*/
fun cairo_fill (ctx: !xr1): void = "mac#atscntrb_cairo_fill"

/*
void                cairo_fill_preserve                 (cairo_t *cr);
*/
fun cairo_fill_preserve (ctx: !xr1): void = "mac#atscntrb_cairo_fill_preserve"
...
, x2: &double? >> double
, y2: &double? >> double
) : void = "mac#atscntrb_cairo_fill_extents"
...
cairo_bool_t        cairo_in_fill                       (cairo_t *cr,
                                                         ...
                                                         double y);
*/
fun cairo_in_fill (ctx: !xr1): bool = "mac#atscntrb_cairo_in_fill"
...
*/
fun cairo_paint (ctx: !xr1): void = "mac#atscntrb_cairo_paint"
...
fun cairo_paint_with_alpha
  (ctx: !xr1, alpha: double): void = "mac#atscntrb_cairo_paint_with_alpha"
...
*/
fun cairo_stroke (ctx: !xr1): void = "mac#atscntrb_cairo_stroke"

/*
void                cairo_stroke_preserve               (cairo_t *cr);
*/
fun cairo_stroke_preserve (ctx: !xr1): void = "mac#atscntrb_cairo_stroke_preserve"
...
, x2: &double? >> double
, y2: &double? >> double
) : void = "mac#atscntrb_cairo_stroke_extents"
...
cairo_bool_t        cairo_in_stroke                     (cairo_t *cr,
                                                         ...
                                                         double y);
*/
fun cairo_in_stroke (ctx: !xr1): bool = "mac#atscntrb_cairo_in_stroke"
...
*/
fun cairo_copy_page (ctx: !xr1): void = "mac#atscntrb_cairo_copy_page"

/*
void                cairo_show_page                     (cairo_t *cr);
*/
fun cairo_show_page (ctx: !xr1): void = "mac#atscntrb_cairo_show_page"
...
fun cairo_get_reference_count
  (ctx: !xr1): uint = "mac#atscntrb_cairo_get_reference_count"
...
) : cairo_status_t = "mac#atscntrb_cairo_set_user_data"
// end of [fun]
...
fun cairo_get_user_data (
  ctx: !xr1
, key: &cairo_user_data_key_t
) : ptr(*dataptr*) = "mac#atscntrb_cairo_get_user_data"
// end of [fun]
