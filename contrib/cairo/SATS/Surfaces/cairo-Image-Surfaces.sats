...
fun cairo_format_stride_for_width
  (format: cairo_format_t, width: int): int = "mac#atsctrb_cairo_format_stride_for_width"
...
fun cairo_image_surface_create
  (format: cairo_format_t, width: int, height: int): xrsf1 = "mac#atsctrb_cairo_image_surface_create"
...
fun cairo_image_surface_get_format
  (xrsf: !xrsf1): cairo_format_t = "mac#atsctrb_cairo_image_surface_get_format"
...
fun cairo_image_surface_get_width
  (xrsf: !xrsf1): int = "mac#atsctrb_cairo_image_surface_get_width"
...
fun cairo_image_surface_get_height
  (xrsf: !xrsf1): int = "mac#atsctrb_cairo_image_surface_get_height"
...
fun cairo_image_surface_get_stride
  (xrsf: !xrsf1): int = "mac#atsctrb_cairo_image_surface_get_stride"
