...
//
function
ats2js_workersession_channeg0_new_file
...
//
function
ats2js_workersession_channeg0_close(chn) { return chn.terminate(); }
function
ats2js_workersession_channeg1_close(chn) { return chn.terminate(); }
//
%} // end of [%{^]
//
(* ****** ****** *)
...
//
function
ats2js_workersession_channeg0_send(chn, k0)
{
  chn.onmessage =
  function(event)
...
function
ats2js_workersession_channeg0_recv(chn, x0, k0)
{
  chn.postMessage(x0); return ats2jspre_cloref1_app(k0, chn);
}
//
function
ats2js_workersession_channeg1_send
  (chn, k0)
{
  return ats2js_workersession_channeg0_send(chn, k0);
}
function
ats2js_workersession_channeg1_recv
  (chn, x0, k0)
{
  return ats2js_workersession_channeg0_recv(chn, x0, k0);
}
//
%} // end of [%{^]
//
