...
prval
ILISTEQ() =
$UNSAFE.proof_assert{ILISTEQ(p1_drop_n,ilist_tail(p1_drop_n_1))}()
//
prval
ILISTEQ() =
$UNSAFE.proof_assert
{ILISTEQ(p1_take_n_1,ilist_take(ilist_append(p1_take_n_1,p3),n-1))}()
//
prval
ILISTEQ() =
$UNSAFE.proof_assert
...
prval
ILISTEQ() =
$UNSAFE.proof_assert{ILISTEQ(p3,ilist_drop(ilist_append(p1_take_n_1,p3),n-1))}()
//
