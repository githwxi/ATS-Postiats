...
extern
fun
Java_MyMatrix_get_1at
(
  !JNIEnvPtr, !jobject0, M: jlong, i: jint, j: jint
) : jint = "ext#" // end of [Java_MyMatrix_get_1at]

extern
fun
Java_MyMatrix_set_1at
(
  !JNIEnvPtr, !jobject0, M: jlong, i: jint, j: jint, x0: jint
) : void = "ext#" // end of [Java_MyMatrix_set_1at]
...
end // end of [Java_MyMatrix_make_1elt]
...
end // end of [Java_MyMatrix_get_1at]
...
end // end of [Java_MyMatrix_set_1at]
