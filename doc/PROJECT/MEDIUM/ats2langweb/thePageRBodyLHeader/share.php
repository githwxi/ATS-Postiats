...
thePageRBodyLHeader_Downloads()
{
  ...
  echo "<li><a href=\"#Scripts_for_installing_ATS_Postiats\">Scripts for installing ATS-Postiats</a></li>\n";
  echo "</ul>\n";
  return;
...
thePageRBodyLHeader_Community()
{
  ...
  echo "<li><a href=\"#ATS_stackoverflow_tag\">StackOverflow tag for ATS</a></li>\n";
...
{
  echo "<ul name=\"Papers\">\n";
  echo "<li><a href=\"#ATSfound\">ATS</a></li>\n";
...
thePageRBodyLHeader_Resources()
{
  ...
  echo "<li><a href=\"#ATS-Postiats_online\">Browse ATS-Postiats on-line</a></li>\n";
