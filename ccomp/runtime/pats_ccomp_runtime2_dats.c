...
** The compilation time is: 2013-6-30:  8h:35m
**
*/
...
} pats_ccomp_runtime_tyexn_0 ;

ATSdyncst_mac(atspre_exit) ;
ATSdyncst_mac(atspre_prerr_string) ;
ATSdyncst_mac(atspre_prerr_newline) ;
ATSdyncst_extfun(
  atsruntime_handle_uncaughtexn_rest, (atstype_exnconptr), atsvoid_t0ype
) ; // end of [ATSdyncst_extfun]
...
ATSbranchbeg() ;
__patstlab_0:
ATSifnot(ATSPATCKexn1(arg0, ATSLIB_056$prelude_IllegalArgExn)) { ATSgoto(__patstlab_2) ; }
__patstlab_1:
ATSINSmove(tmp1, ATSSELcon(arg0, pats_ccomp_runtime_tyexn_0, atslab$0)) ;
ATSINSfreecon(arg0) ;
/*
ibranch-mbody:
*/
...
ATSINSmove_void(tmp4, atspre_prerr_string(ATSPMVstring(": IllegalArgExn: "))) ;
ATSINSmove_void(tmp5, atspre_prerr_string(tmp1)) ;
ATSINSmove_void(tmp6, atspre_prerr_newline()) ;
/*
letpush(end)
*/
...
ATSbranchbeg() ;
__patstlab_2:
ATSifnot(ATSPATCKexn1(arg0, ATSLIB_056$prelude_NotImplementedExn)) { ATSgoto(__patstlab_4) ; }
__patstlab_3:
ATSINSmove(tmp2, ATSSELcon(arg0, pats_ccomp_runtime_tyexn_0, atslab$0)) ;
ATSINSfreecon(arg0) ;
/*
ibranch-mbody:
*/
...
letpush(beg)
*/
ATSINSmove_void(tmp7, atspre_prerr_string(ATSPMVstring(": NotImplementedExn: "))) ;
ATSINSmove_void(tmp8, atspre_prerr_string(tmp2)) ;
ATSINSmove_void(tmp9, atspre_prerr_newline()) ;
/*
letpush(end)
*/
