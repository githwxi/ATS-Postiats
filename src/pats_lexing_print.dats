...
//
  ...
  | T_IN () => fprintf (out, "IN()", @())
  | T_INFIX (x) => fprintf (out, "INFIX(%i)", @(x))
  | T_LAM (x) => fprintf (out, "LAM(%i)", @(x))
  | T_LET () => fprintf (out, "LET()", @())
  | T_LOCAL () => fprintf (out, "LOCAL()", @())
  | T_MACDEF () => fprintf (out, "MACDEF()", @())
  | T_MACRODEF () => fprintf (out, "MACRODEF()", @())
  | T_NONFIX () => fprintf (out, "NONFIX()", @())
  | T_OVERLOAD () => fprintf (out, "OVERLOAD()", @())
  | T_POSTFIX () => fprintf (out, "POSTFIX()", @())
  | T_PREFIX () => fprintf (out, "PREFIX()", @())
  | T_OF () => fprintf (out, "OF()", @())
  | T_OP () => fprintf (out, "OP()", @())
...
//
  ...
  | T_INTEGER_dec (x) => fprintf (out, "INTEGER_dec(%s)", @(x))
  | T_INTEGER_oct (x) => fprintf (out, "INTEGER_oct(%s)", @(x))
  | T_INTEGER_hex (x) => fprintf (out, "INTEGER_hex(%s)", @(x))
