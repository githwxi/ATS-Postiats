...
#define
ATS_EXTERN_PREFIX
"atscntrb_html_emscripten_"
//
(* ****** ****** *)
//
fun
document_get_documentElement_clientWidth
  (): int = "ext#%"
fun
document_get_documentElement_clientHeight
  (): int = "ext#%"
//
(* ****** ****** *)
//
absvtype
element_vtype(l:addr) = ptr(l)
//
...
//
fun
document_element_free(elt: element0): void = "ext#%"
//
(* ****** ****** *)

fun
document_getElementById(id: string): element0 = "ext#%"

(* ****** ****** *)
//
fun
document_element_get_width (!element1): int = "ext#%"
fun
document_element_set_width (!element1, width: int): void = "ext#%"
//
fun
document_element_get_height (!element1): int = "ext#%"
fun
document_element_set_height (!element1, height: int): void = "ext#%"
//
(* ****** ****** *)

fun
document_element_get_value_int (!element1): int = "ext#%"
fun
document_element_get_value_string (!element1): string = "ext#%"
